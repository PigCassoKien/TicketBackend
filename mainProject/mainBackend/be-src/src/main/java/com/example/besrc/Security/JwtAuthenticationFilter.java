...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        try {
            ...
            // ✅ Bỏ qua xác thực nếu là API công khai
            if (requestPath.startsWith("/api/film/getFilm") || requestPath.startsWith("/api/film/getFilmsByStatus") || requestPath.startsWith("/api/film/searchFilmsByPrefix") || requestPath.startsWith("/api/film/getFilms")) {
