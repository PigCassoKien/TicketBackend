...
public interface CinemaShowRepository extends JpaRepository<Show, String> {
    ...
    List<Show> findConflictingShows(@Param("startTime")LocalDateTime startTime, @Param("hallId")Long stadiumHallId);
    ...
    Show findByHallHallIdAndFilmFilmId(@Param("hallId") String stadiumHallId, @Param("filmId") @NotBlank @NotNull String filmId, @Param("startTime") LocalDateTime startTime);
}
