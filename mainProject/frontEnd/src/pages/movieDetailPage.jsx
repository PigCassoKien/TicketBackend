...
const MovieDetailPage = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      try {
        const response = await axios.get(`https://ticketcinema-backend.onrender.com/api/film/getFilm/${id}`);
    ...
    const fetchShowtimes = async () => {
      try {
        const response = await axios.get(`https://ticketcinema-backend.onrender.com/api/show/getByFilm?filmId=${id}`);
  ...
  const BASE_URL = "https://ticketcinema-backend.onrender.com/largeImages";
