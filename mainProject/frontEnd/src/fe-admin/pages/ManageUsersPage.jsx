...
const ManageUsersPage = () => {
  ...
  useEffect(() => {
    const fetchAllUsers = async () => {
      try {
        const response = await axios.get("https://localhost:8443/api/account/admin/all", {
          headers: {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await axios.get(
        `https://localhost:8443/api/account/admin/search?username=${searchTerm}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleViewUser = async (username) => {
    try {
      const response = await axios.get(
        `https://localhost:8443/api/account/admin/${username}/information`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      await axios.delete(`https://localhost:8443/api/account/admin/delete?username=${userToDelete}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleGiveAdminRole = async () => {
    try {
      const response = await axios.get(
        `https://localhost:8443/api/account/superadmin/giveAdmin?username=${userForAdminAction}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const updatedUsers = await axios.get("https://localhost:8443/api/account/admin/all", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleRemoveAdminRole = async () => {
    try {
      const response = await axios.get(
        `https://localhost:8443/api/account/superadmin/removeAdmin?username=${userForAdminAction}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
