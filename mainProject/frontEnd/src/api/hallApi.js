...
export const getAllHalls = async () => {
  return makeAuthenticatedRequest({
    method: "GET",
    url: "https://ticketcinemaweb.onrender.com/api/hall/all",
  });
};
...
export const getHallById = async (hallId) => {
  return makeAuthenticatedRequest({
    method: "GET",
    url: `https://ticketcinemaweb.onrender.com/api/hall/${hallId}`,
  });
};
...
export const createHall = async (hallData) => {
  return makeAuthenticatedRequest({
    method: "POST",
    url: "https://ticketcinemaweb.onrender.com/api/hall/create",
    data: hallData,
    headers: {
...
export const updateHall = async (hallId, hallData) => {
  return makeAuthenticatedRequest({
    method: "PUT",
    url: `https://ticketcinemaweb.onrender.com/api/hall/update/${hallId}`,
    data: hallData,
    headers: {
      "Content-Type": "application/json",
    },
...
export const deleteHall = async (hallId) => {
  return makeAuthenticatedRequest({
    method: "DELETE",
    url: `https://ticketcinemaweb.onrender.com/api/hall/delete/${hallId}`,
  });
};