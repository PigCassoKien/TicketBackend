...
export const getAllHalls = async () => {
  return makeAuthenticatedRequest({
    method: "GET",
    url: "https://localhost:8080/api/hall/all",
  });
};
...
export const getHallById = async (hallId) => {
  return makeAuthenticatedRequest({
    method: "GET",
    url: `https://localhost:8080/api/hall/${hallId}`,
  });
};
...
export const createHall = async (hallData) => {
  return makeAuthenticatedRequest({
    method: "POST",
    url: "https://localhost:8080/api/hall/create",
    data: hallData,
    headers: {
...
export const updateHall = async (hallId, hallData) => {
  return makeAuthenticatedRequest({
    method: "PUT",
    url: `https://localhost:8080/api/hall/update/${hallId}`,
    data: hallData,
    headers: {
      "Content-Type": "application/json",
    },
...
export const deleteHall = async (hallId) => {
  return makeAuthenticatedRequest({
    method: "DELETE",
    url: `https://localhost:8080/api/hall/delete/${hallId}`,
  });
};