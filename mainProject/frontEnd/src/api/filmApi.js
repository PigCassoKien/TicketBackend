// src/api/filmApi.js
const BASE_URL = "https://ticketcinema-backend.onrender.com/api/film";
...
export const getShowtimesByFilm = async (filmId) => {
  try {
    ...
    const response = await fetch(`https://ticketcinema-backend.onrender.com/api/show/getByFilm?filmId=${filmId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
